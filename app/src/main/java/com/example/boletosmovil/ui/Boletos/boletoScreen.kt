...
@Composable
fun boletoScreen(navHostController: NavHostController, viewModel: eventoViewModel = hiltViewModel()) {
    ...
    TopAppBar(
        ...
        LazyColumn {
            items(uiStateB.value.boleto) {
                    ...
                    boleto -> BoletoRow(boleto = boleto, navController = navHostController)
            }
        }
